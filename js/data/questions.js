const QUESTIONS = {
  facile: [
    ...
    { type: "open", text: "Quel est mon signe astrologique ?" },
    { type: "open", text: "Quelle est la chose que je déteste le plus manger ?" },
  ],
  ...
  moyen: [
    ...
    { type: "open", text: "Décris mon corps avec 4 adjectifs seulement." },
    { type: "open", text: "Quelle est la chose la plus coquine que tu aies déjà faite ?" },
  ],
  ...
  chaud: [
    ...
    { type: "open", text: "Si je te donnais un ordre coquin maintenant, lequel accepterais-tu ?" },
  ...
  torride: [
    ...
    { type: "open", text: "Si je te donnais un ordre très coquin maintenant, lequel accepterais-tu sans hésiter ?" },
    ...
    { type: "open", text: "Décris comment tu aimerais me faire jouir ce soir." },
    { type: "open", text: "Quelle est la chose la plus interdite que tu aimerais qu’on fasse ?" },
  ]
};
